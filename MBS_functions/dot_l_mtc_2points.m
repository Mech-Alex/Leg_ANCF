function dot_l_MTC_sol = dot_l_mtc_2points(body1coordvec, body2coordvec, dot_body1coordvec, dot_body2coordvec, u1, u2) 
...
J2 = Jac(body2coordvec(4),body2coordvec(5),body2coordvec(6),body2coordvec(7),u2(1),u2(2),u2(3));

% Calculate the time derivatives of the positions
dp1dt = J1 * dot_body1coordvec;
dp2dt = J2 * dot_body2coordvec;

% Calculate the time derivative of the distance
dot_l_MTC_sol = dot(dp2dt - dp1dt, (p2_sol - p1_sol)) / l_mtc_sol;
