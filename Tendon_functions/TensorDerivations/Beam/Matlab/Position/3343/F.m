...
t943 = 1.0./t942;
t944 = 1.0./t941;
mt1 = [t560.*((q1.*t11)./2.0+(q25.*t2)./2.0+(q1.*xi)./2.0-q13.*xi.*2.0+(q25.*xi)./2.0+(W.*q7.*t11.*zeta)./4.0+(W.*q31.*t2.*zeta)./4.0+(W.*q7.*xi.*zeta)./4.0-W.*q19.*xi.*zeta+(W.*q31.*xi.*zeta)./4.0+(H.*eta.*q4.*t11)./4.0+(H.*eta.*q28.*t2)./4.0+(H.*eta.*q4.*xi)./4.0-H.*eta.*q16.*xi+(H.*eta.*q28.*xi)./4.0+(H.*W.*eta.*q10.*t11.*zeta)./8.0+(H.*W.*eta.*q34.*t2.*zeta)./8.0+(H.*W.*eta.*q10.*xi.*zeta)./8.0-(H.*W.*eta.*q22.*xi.*zeta)./2.0+(H.*W.*eta.*q34.*xi.*zeta)./8.0).*2.0-t927.*t940.*t944.*2.0-t930.*t939.*t943.*2.0];
mt2 = [t560.*((q2.*t11)./2.0+(q26.*t2)./2.0+(q2.*xi)./2.0-q14.*xi.*2.0+(q26.*xi)./2.0+(W.*q8.*t11.*zeta)./4.0+(W.*q32.*t2.*zeta)./4.0+(W.*q8.*xi.*zeta)./4.0-W.*q20.*xi.*zeta+(W.*q32.*xi.*zeta)./4.0+(H.*eta.*q5.*t11)./4.0+(H.*eta.*q29.*t2)./4.0+(H.*eta.*q5.*xi)./4.0-H.*eta.*q17.*xi+(H.*eta.*q29.*xi)./4.0+(H.*W.*eta.*q11.*t11.*zeta)./8.0+(H.*W.*eta.*q35.*t2.*zeta)./8.0+(H.*W.*eta.*q11.*xi.*zeta)./8.0-(H.*W.*eta.*q23.*xi.*zeta)./2.0+(H.*W.*eta.*q35.*xi.*zeta)./8.0).*2.0-t928.*t940.*t944.*2.0-t931.*t939.*t943.*2.0];
mt3 = [t560.*((q3.*t11)./2.0+(q27.*t2)./2.0+(q3.*xi)./2.0-q15.*xi.*2.0+(q27.*xi)./2.0+(W.*q9.*t11.*zeta)./4.0+(W.*q33.*t2.*zeta)./4.0+(W.*q9.*xi.*zeta)./4.0-W.*q21.*xi.*zeta+(W.*q33.*xi.*zeta)./4.0+(H.*eta.*q6.*t11)./4.0+(H.*eta.*q30.*t2)./4.0+(H.*eta.*q6.*xi)./4.0-H.*eta.*q18.*xi+(H.*eta.*q30.*xi)./4.0+(H.*W.*eta.*q12.*t11.*zeta)./8.0+(H.*W.*eta.*q36.*t2.*zeta)./8.0+(H.*W.*eta.*q12.*xi.*zeta)./8.0-(H.*W.*eta.*q24.*xi.*zeta)./2.0+(H.*W.*eta.*q36.*xi.*zeta)./8.0).*2.0-t929.*t940.*t944.*2.0-t932.*t939.*t943.*2.0,t927.*t934.*t937.*-4.0+t930.*t933.*t938.*4.0];
mt4 = [t928.*t934.*t937.*-4.0+t931.*t933.*t938.*4.0,t929.*t934.*t937.*-4.0+t932.*t933.*t938.*4.0,t927.*t933.*t937.*4.0+t930.*t934.*t938.*4.0,t928.*t933.*t937.*4.0+t931.*t934.*t938.*4.0,t929.*t933.*t937.*4.0+t932.*t934.*t938.*4.0];
